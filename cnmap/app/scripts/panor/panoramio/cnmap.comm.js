...
// 全局命名空间
  ...
  window.cnmap.utils = window.cnmap.utils || {};

  window.cnmap.utils.uuid = function () {
  ...
  window.cnmap.utils.getLocalCity = function (callback/*city*/) {
...
//            this.geocoder.geocode(address, callback);
  ...
  window.cnmap.utils.compareArray = function (arrayA, arrayB, callback) {
    if (arrayA && arrayB) {

...
public class KMeans_Ex4a {
	...
	private static final double SAMPLES[][] = new double[][] { { 1.0, 1.0 },
			...
			{ 4.5, 5.0 }, { 3.5, 4.5 }, {100, 200}, {101, 199} };
	...
	private static void initialize() {
		...
		centroids.add(new Centroid(101, 199)); // lowest set.
		centroids.add(new Centroid(101, 199)); // highest set.
	...
	private static void kMeanCluster() {
		final double bigNumber = Math.pow(10, 10); // some big number that's
													...
													// our data range.
		int total_data = SAMPLES.length; // Total data points.

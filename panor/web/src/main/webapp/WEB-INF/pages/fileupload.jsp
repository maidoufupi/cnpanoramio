...
<div class="span7">
	...
	<form id="photoUpload" action="<c:url value="/services/api/photo"/>" 
	  enctype="multipart/form-data">
	  <input type="file" name="file" multiple="" class="upload_input">
	</form>
</div>
<c:set var="scripts" scope="request">
    ...
    <script type="text/javascript"
		src="<c:url value="/scripts/photoUpload.js"/>"></script>
</c:set>
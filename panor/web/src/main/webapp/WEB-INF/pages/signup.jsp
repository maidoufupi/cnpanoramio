...
<div class="span7">
    ...
    <form:form commandName="user" method="post" action="signup" id="signupForm" autocomplete="off"
        ...
        <fieldset class="control-group${(not empty status.errorMessage) ? ' error' : ''}">
            ...
            <div class="controls">
                <form:password path="password" id="password" showPassword="true" class="form-control" placeholder="password"/>
        ...
        <fieldset class="control-group${(not empty status.errorMessage) ? ' error' : ''}">
            ...
            <div class="controls">
                <form:password path="confirmPassword" id="confirmPassword" showPassword="true" class="form-control" placeholder="Confirm password"/>

            ...
            <ul id="details">
                ...
                <li id="tech-details">
                    <ul>
                        ...
                        <li>拍摄日期：{{cameraInfo.dateTimeOriginal}}</li>
                        <li>曝光时间：{{cameraInfo.exposureTime}}</li>
                        <li>焦距：{{cameraInfo.focalLength}}</li>
                        <li>光圈： {{cameraInfo.fnumber}}</li>
                        <li>ISO：{{cameraInfo.iso}}</li>
                        <li>曝光补偿： {{cameraInfo.exposureBias}}</li>
